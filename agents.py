...
prompt_helper = ChatPromptTemplate.from_messages(
    [
        (
            "system",
            """
            Você é um desenvolvedor sênior cujo objetivo é facilitar a integração do novo funcionários da sua empresa, ajudando-os a se familiarizar rapidamente
...
agent_request_identifier_with_chat_history = RunnableWithMessageHistory(
...
def identify_request(input: str, username) -> str:
    ...
    identification_result = agent_request_identifier_with_chat_history.invoke(
